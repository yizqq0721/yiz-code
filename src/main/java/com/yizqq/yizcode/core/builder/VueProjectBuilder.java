package com.yizqq.yizcode.core.builder;
...
public class VueProjectBuilder {
     ...
     * 操作系统检测
     *
     * @return 操作系统名称，例如 "Windows" 或 "Linux"
     */
     ...
     * 执行命令
     *
     * @param workingDir     工作目录，即命令执行的当前目录
     * @param command        命令字符串，例如 "ls -la"
     * @param timeoutSeconds 超时时间（秒），如果命令执行时间超过该值则终止进程
     * @return 是否执行成功
     */
